                        ...
                        if (File.Exists(Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), ""<module_name><module_extension>"")))
                            {
                                ...
                                // Open excel sheet
                                this.excelApplication.Workbooks.Open(Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), ""<module_name><module_extension>""));
                            ...
                            {
                                // Advice user
                                MessageBox.Show(""<module_name><module_extension> not present."", ""Missing excel file"", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            }
                    }
